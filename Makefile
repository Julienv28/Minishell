...
SRCS        = $(SRC_DIR)/main.c $(SRC_DIR)/pipes_manager.c $(SRC_DIR)/initialisation_args.c $(SRC_DIR)/split_args.c \
			  ...
			  $(SRC_DIR)/tokenization/check_cmd.c $(SRC_DIR)/tokenization/arguments.c $(SRC_DIR)/dollard.c \
...
# Ajout des chemins de bibliothèque pour readline
LDFLAGS     = -L$(shell brew --prefix readline)/lib

all: $(LIBFT) $(NAME)

$(NAME): $(OBJS) $(LIBFT)
	$(CC) $(CFLAGS) $(OBJS) $(LDFLAGS) -L $(LIBFT_DIR) -lft -lreadline -o $(NAME)
